...
<head>
	...
	<title>ePakan | cara membeli</title>
</head>
<body>
	...
	<div id="account-options-menu" class="side-menu right closed">
		...
		<ul class="dropdown dark hover-effect">
			...
			<!-- DROPDOWN ITEM -->
			<li class="dropdown-item">
				<a href="dashboard-purchases.html">Logout</a>
			</li>
			<!-- /DROPDOWN ITEM -->
...
<!-- Mirrored from odindesign-themes.com/emerald-dragon/how-to-shop.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Mar 2019 18:24:08 GMT -->
</html>
