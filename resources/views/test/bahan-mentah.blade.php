...
<body>
				...
				<div class="account-information">
					...
					<div class="account-cart-quickview">
						<span>
							...
							<a href="http://marketplace.epakan.id/keranjang" class="icon-present">
							<!-- SVG ARROW -->
	...
	<div id="mobile-menu" class="side-menu left closed">
		...
		<ul class="dropdown dark hover-effect interactive">
			...
			<!-- DROPDOWN ITEM -->
			<li class="dropdown-item">
				<a href="how-to-shop.html">Cara Membeli</a>
			</li>
			<!-- /DROPDOWN ITEM -->
			...
			<div class="content">
				...
				<div class="headline tertiary">
					...
					<div class="view-selectors">
						<a href="{{ route('test') }}" class="view-selector grid active"></a>
					...
					<form id="shop_filter_form" name="shop_filter_form">
						<label for="price_filter" class="select-block">
							<select name="price_filter" id="price_filter">
								<option value="0">Harga Tertinggi ke Terendah</option>
					...
					<div class="product-list grid column3-4-wrap">
						...
						<div class="product-item column">
							...
							<div class="product-info">
								<a href="{{ route('test10') }}">
									<p class="text-header">Pakan Sapi Ternak</p>
								</a>
								<p class="product-description">Lorem ipsum dolor sit urarde...</p>
								
									<p class="category tertiary">Pakan</p>
			...
			<div class="sidebar">
				...
				<ul class="dropdown hover-effect tertiary">
                    ...
                    <br/>
                    	<hr class="line-separator">
					<li class="dropdown-item">
						<a href="{{ route('test') }}">Pakan Sapi</a>
					</li>
					<li class="dropdown-item">
						<a href="{{ route('test2') }}">Pakan Kuda</a>
					</li>
					<li class="dropdown-item">
						<a href="{{ route('test3') }}">Pakan Domba & Kambing</a>
					</li>
					<li class="dropdown-item">
						<a href="{{ route('test4') }}">Pakan Ayam</a>
					</li>
					<li class="dropdown-item">
						<a href="{{ route('test5') }}">Pakan Kerbau</a>
					</li>
                    <li class="dropdown-item">
						<a href="{{ route('test6') }}">Supplement</a>
					</li>
                    <li class="dropdown-item">
						<a href="{{ route('test7') }}">Hijauan</a>
					</li>
                    <li class="dropdown-item active">
						<a href="#">Bahan Mentah Pakan</a>
					</li>
                    <li class="dropdown-item">
						<a href="{{ route('test9') }}">Produk Peternak Binaan</a>
					</li>
				</ul>
				<!-- /DROPDOWN -->
