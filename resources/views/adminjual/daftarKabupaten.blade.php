...
<body>
    ...
    <br><br><br>
    <form method="get" action="{{ route('ongkir') }}">
    @csrf
        <div class="modal-body">

            <div class="input-container">
                <label for="daerah" class="">Pilih Kabupaten</label>
                    <select name="daerah" class="form-control" id="exampleFormControlSelect1">
        ...
        <div class="modal-footer">
            <button  type="submit" class="btn btn-success" style="color:#ffffff">Pilih</button>
        </div>
    </form>
    <br><br> 
