			...
			<div class="content right">
				<!-- CART -->
					...
					<nav class="nav nav-pills flex-column flex-sm-row">
						<a class="flex-sm-fill text-sm-center nav-link " href="{{route('belumbayar')}}">Belum Bayar</a>
						...
						<a class="flex-sm-fill text-sm-center nav-link active" href="{{route('diterima')}}">Diterima</a>
					...
					<div class="cart belumbayar">
						<div class="p-3">
							...
							<div class="container">
								...
								<button type="button" class="btn btn-success float-right">Terkirim</button>
							</div>
