...
<head>
	...
	<title>ePakan | Ubah Produk</title>
</head>
<body>
					...
					@csrf
						...
						<div class= "pt-2 pl-5 pr-5"  >
							<div class="form-group">
								<input type="produk" class="form-control" name="nama" id="exampleInputnamaproduk" aria-describedby="produklHelp" placeholder="Nama Produk" value="{{$produk->nama}}">
							</div>
							<div class="form-group">
								<input type="produk" class="form-control" name="jenis" id="exampleInputnamaproduk" aria-describedby="produklHelp" placeholder="jenis" value="{{$produk->jenis}}">
							</div>

							<div class="form-group">
								<input type="produk" class="form-control" name="harga" id="exampleInputnamaproduk" aria-describedby="produklHelp" placeholder="Harga Produk" value="{{$produk->harga}}">
							</div>

							<div class="input-group mb-3">
								<input type="text" class="form-control" name="satuan" placeholder="Satuan Produk" aria-label="Recipient's username" aria-describedby="basic-addon2" value="{{$produk->satuan}}">
							</div>

							<div class="form-group">
								<input type="number" class="form-control" name="minimum"  aria-describedby="produklHelp" placeholder="minimum" value="{{$produk->minimum}}">
							</div>

							<div class="form-group">
								<input type="number" class="form-control" name="stok"  aria-describedby="produklHelp" placeholder="stok" value="{{$produk->stok}}">
							</div>
							...
							<div class="form-group">
                                <select class="form-control" name="kategori" id="exampleFormControlSelect1">
										...
										<option value="Produk Peternak Binaan">Produk Peternak Binaan</option>
                                </select>
                            </div>
							...
							<div class="form-group">
								...
								<option value="{{$produk->lokasi}}">{{$produk->lokasi}}</option>
							...
							<div class="custom-file">
								<label for="exampleFormControlFile1">Pilih Foto 2</label>
  								  <input type="file" name="foto2" class="form-control-file" id="exampleFormControlFile1">

							</div><br/><br/>
							<div class="custom-file">
								<label for="exampleFormControlFile1">Pilih Foto 3</label>
  								  <input type="file" name="foto3" class="form-control-file" id="exampleFormControlFile1">

							</div>
							<br/><br/>
							<div class="form-group">
								<textarea class="form-control" name="deskripsi" id="exampleFormControlTextarea1"placeholder="Deskripsi Produk" rows="3">{{$produk->deskripsi}}</textarea>
							</div>
							<center>
							<button type="submit" class="btn btn-success">Tambah Produk</button></center>
