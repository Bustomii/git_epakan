			...
			@if ($data != NULL)
                ...
                <!-- CART -->
						<div class="p-3">
							...
							<h4 class="float-right" >Nama Kecamatan : {{$data['kec']}}</h4>

							<h4>Nama Kabupaten :  {{$data['kab']}} </h4>
              ...
              <br>
              <form method="get" action="{{route('tambahOngkir')}}">
							@csrf
				<label >Tarif Ongkir</label>
				<input type="hidden" id="id_daerah" name="daerah" value="{{$data['id_kab']}}">
				<input type="hidden" id="id_penjual" name="id_penjual" value="{{$pengguna['id']}}">
				<input type="hidden" id="id_kec" name="id_kec" value="{{$data['id_kec']}}">
				<input type="hidden" id="id_ongkir" name="id_ongkir" value="{{$data['id_ongkir']}}">
				<input type="hidden" id="cek" name="cek" value="{{$data['id_ongkir']}}">
                <input type="number" id="ongkir" name="ongkir" placeholder ="Masukan ongkir" value="{{$data['ongkir']}}">
                <br>
                <br>
				@else
                ...
                <!-- CART -->
						<div class="p-3">
							...
							<h4 class="float-right" >Nama Kecamatan : {{$keca['kec']}}</h4>

							<h4>Nama Kabupaten :  {{$keca['kab']}} </h4>
							<hr/>
              ...
              <form method="get" action="{{route('tambahOngkir')}}">
							@csrf
				<label >Tarif Ongkir</label>
				<input type="hidden" id="id_daerah" name="daerah" value="{{$keca['id_kab']}}">
				<input type="hidden" id="id_penjual" name="id_penjual" value="{{$pengguna['id']}}">
				<input type="hidden" id="id_kec" name="id_kec" value="{{$keca['id_kec']}}">
				<input type="hidden" id="id_ongkir" name="id_ongkir" value="">
				<input type="hidden" id="cek" name="cek" value="">
                <input type="number" id="ongkir" name="ongkir" placeholder ="Masukan ongkir">
                <br>
                <br>
				@endif
                <button type="submit" class="btn btn-success float-right">Simpan Ongkir</button>
