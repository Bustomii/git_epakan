	...
	<div class="section-wrap">
		<div class="section">
			...
			<div class="sidebar left">
				...
				<form class= p-3 method="POST" action="{{route('cairkanMitra')}}" enctype="multipart/form-data">
				@csrf
				<?php if($total!=NULL) {?>
				...
				?>
						...
						<br/>
                    	<br/>
						<a href="{{ route('lokasi') }}">Atur Lokasi Toko</a>
                    	<br/>
                 		<br/>
						 <a href="{{ route('lokasi') }}">Daftar Lokasi Pengiriman</a>
                    	<br/>
                 		<br/>
						<a href="{{ route('bantuan') }}">Pusat Bantuan</a>
										<br/>
                 		<br/>
						<a href="{{ route('daftar') }}">Daftar Mitra</a>
			...
			<div class="content right">
				<!-- CART -->
					...
					<nav class="nav nav-pills flex-column flex-sm-row">
						<a class="flex-sm-fill text-sm-center nav-link active" href="#">Belum Bayar</a>
						<a class="flex-sm-fill text-sm-center nav-link" href="{{route('diproses')}}">Diproses</a>
						<a class="flex-sm-fill text-sm-center nav-link" href="{{route('dikirim')}}">Dikirim</a>
