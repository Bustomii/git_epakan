...
<head>
	...
	<title>ePakan | Ubah-barang</title>
</head>
<body>
		...
		<div class="section">
			...
			<div class="sidebar right">
				...
				<div class="sidebar-item void buttons">
					<a  class="btn btn-light btn-block" style="height:40px;margin-bottom:10px">
						<p align="center" style="color:#000">Rp. {{ number_format($produk->harga , 0, ',', '.') }} <span>/</span>  <span > {{ $produk->satuan }}</span></p>
					</a>
				</div>
                ...
                <div class="sidebar-item void buttons">
					<a  href="{{Route('ubah-produk',$produk->id)}}" class="btn btn-success btn-block" style="height:40px;margin-bottom:10px">
						<p align="center" style="color:#000">ubah</p>
					</a>
				</div>
			...
			<div class="content left">
				...
				<article class="post" style="height:auto">
					...
					<hr class="line-separator">
					<div>
					<h2 style="color:#000"> {{ $produk->nama }}<h2></div>
                    <p>{{ $produk->lokasi }}</p>
					<hr class="line-separator">
					<!-- POST CONTENT -->
...
<!-- Item V1 -->
<script src="js/item-v2.js"></script>
<!-- Tooltip -->
