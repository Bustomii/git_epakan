					...
					@csrf
						...
						<div class= "pt-2 pl-5 pr-5"  >
							<div class="form-group">
								<input type="produk" class="form-control" name="nama" id="exampleInputnamaproduk" aria-describedby="produklHelp" placeholder="Nama Produk">
							</div>
							<!-- <div class="form-group">
								<input type="produk" class="form-control" name="jenis" id="exampleInputnamaproduk" aria-describedby="produklHelp" placeholder="jenis">
							</div> -->

							<div class="form-group">
								<input type="produk" class="form-control" name="harga" id="exampleInputnamaproduk" aria-describedby="produklHelp" placeholder="Harga Produk">
							</div>

							<div class="input-group mb-3">
								<input type="text" class="form-control" name="satuan" placeholder="Satuan Produk" aria-label="Recipient's username" aria-describedby="basic-addon2">

							</div>

							<div class="form-group">
								<input type="number" class="form-control" name="minimum"  aria-describedby="produklHelp" placeholder="minimum">
							</div>

							<div class="form-group">
								<input type="number" class="form-control" name="stok"  aria-describedby="produklHelp" placeholder="stok">
							</div>
							...
							<div class="form-group">
								...
								<option value="Tentukan Lokasi">Tentukan Lokasi</option>
							...
							<br/><br/>
							<div class="form-group">
								<textarea class="form-control" name="deskripsi" id="exampleFormControlTextarea1"placeholder="Deskripsi Produk" rows="3"></textarea>
							</div>
							<center>
