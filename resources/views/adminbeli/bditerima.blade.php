			...
			<div class="content right">
				<!-- CART -->
					...
					<nav class="nav nav-pills flex-column flex-sm-row">
						...
						<a class="flex-sm-fill text-sm-center nav-link active" href="{{route('bditerima')}}">Diterima</a>
							...
							<div class="container">
								<div class="row">
									<div class="col-sm">
										...
										<img src="{{ asset('uploads/file/'.$data->pesanan->foto) }}" style="height:110%" alt="product-image">										</figure>
									</div>
									<div class="col-sm">
										<p>Total Harga Pakan  : {{$data->harga}}</P>
										<p>Total Ongkos Kirim : {{$data->ongkir}}</p>
