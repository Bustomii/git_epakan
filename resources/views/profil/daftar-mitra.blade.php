	...
	<div class="section-wrap">
		<div class="section">
			...
			<div class="sidebar left">
				...
				<div class="sidebar-item">
					...
					<h4>{{Auth::guard('pengguna')->user()->nama}}</h4>
						...
						<a href="{{ route('daftar') }}">Peternak</a>
                    	<br/>
                 		<br/>
				        <a href="">Produsen Pakan</a>
						<br/>
                    	<br/>
                        <a href="#">Petani</a>
                        <br/>
			...
			<div class="content right">
                ...
                <div class="cart">
                    <br/>
                    <h3>Silahkan Isi dan Lengkapi Data dan Dokumen Anda</h3>
                    <br/>
					    <form class= p-3 method="POST" action="{{route('daftar-mitra-new')}}" enctype="multipart/form-data">
							@csrf
							<input type="hidden" name="id_pengguna" value="{{Auth::guard('pengguna')->user()->id}}">
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-2 col-form-label">Nama</label>
                                    <div class="col-sm-10">
                                        <input type="name" name="nama" class="form-control" id="inputEmail3" placeholder="Nama Lengkap" required>
                                    </div>
                            </div>
							<div class="form-group row">
                                <label for="inputEmail3" class="col-sm-2 col-form-label">NIK</label>
                                    <div class="col-sm-10">
                                    <input type="name" name="nik" class="form-control" id="inputEmail3" placeholder="NIK" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-2 col-form-label">KTP</label>
                                    <div class="col-sm-10">
                                    <div class="custom-file">
                                            <input type="file" name="ktp" class="custom-file-input" id="inputGroupFile01" aria-describedby="inputGroupFileAddon01" required>
                                            <label class="custom-file-label" for="inputGroupFile01">KTP</label>
                                         </div>
                                    </div>
                            	</div>
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-2 col-form-label">foto peternakan</label>
                                    <div class="col-sm-10">
                                        <div class="custom-file">
                                            <input type="file" name="foto_peternakan" class="custom-file-input" id="inputGroupFile01" required>
                                            <label class="custom-file-label" for="inputGroupFile01">foto peternakan</label>
                                         </div>
                                     </div>
                            	</div>
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-2 col-form-label">Foto CPPB</label>
                                    <div class="col-sm-10">
                                    <div class="custom-file">
                                            <input type="file" name="foto_cppb" class="custom-file-input" id="inputGroupFile01" aria-describedby="inputGroupFileAddon01" required>
                                            <label class="custom-file-label" for="inputGroupFile01">Foto CPPB</label>
                                         </div>
                                    </div>
 	                           </div>
							<div class="form-group row">
                                <label for="inputEmail3" class="col-sm-2 col-form-label">Foto Sertifikat</label>
                                    <div class="col-sm-10">
                                    <div class="custom-file">
                                            <input type="file" name="foto_sertifikat" class="custom-file-input" id="inputGroupFile01" aria-describedby="inputGroupFileAddon01" required>
                                            <label class="custom-file-label" for="inputGroupFile01">Foto Sertifikat</label>
                                         </div>
                                    </div>
                            	</div>
						<center>
                         <button type="submit" class="btn btn-success" onclick="return confirm('Apakah Anda Yakin Ingin Mendaftar Mitra')">Daftar</button></center>
                    </form>
