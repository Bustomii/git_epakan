			...
			@if(Auth::guard('pengguna')->check())
				...
				<div class="user-quickview">
					...
					<div class="outer-ring">
						...
						<img src="{{asset('uploads/file/'. Auth::guard('pengguna')->user()->foto)}}" alt="profile-default-image">
					</figure>
					</div>
					</a>
					<!-- /USER AVATAR -->
		...
		<div class="section overflowable">
			...
			<div class="sidebar left author-profile">
				...
				<div class="sidebar-item author-bio">
					...
					<!-- /USER AVATAR -->
					<p class="text-header">{{$pengguna->nama}}</p>
					<p class="text-oneline">Penjual Pakan Ternak<br>{{$pengguna->daerah}}</p>
					<!-- SHARE LINKS -->
                ...
                <ul class="dropdown hover-effect tertiary">
                    ...
                    <li class="dropdown-item ">
						<a href="{{ route('profil-produk',['id'=>$pengguna->id, 'kategori'=>'Pakan Sapi']) }}">Pakan Sapi</a>
					</li>
					<li class="dropdown-item">
						<a href="{{ route('profil-produk',['id'=>$pengguna->id, 'kategori'=>'Pakan Kuda']) }}">Pakan Kuda</a>
					</li>
					<li class="dropdown-item">
						<a href="{{ route('profil-produk',['id'=>$pengguna->id, 'kategori'=>'Pakan Domaba & Kambing']) }}">Pakan Domba & Kambing</a>
					</li>
					<li class="dropdown-item">
						<a href="{{ route('profil-produk',['id'=>$pengguna->id, 'kategori'=>'Pakan Ayam']) }}">Pakan Ayam</a>
					</li>
					<li class="dropdown-item">
						<a href="{{ route('profil-produk',['id'=>$pengguna->id, 'kategori'=>'Pakan Kerbau']) }}">Pakan Kerbau</a>
					</li>
                    <li class="dropdown-item">
						<a href="{{ route('profil-produk',['id'=>$pengguna->id, 'kategori'=>'Supplement']) }}">Supplement</a>
					</li>
                    <li class="dropdown-item">
						<a href="{{ route('profil-produk',['id'=>$pengguna->id, 'kategori'=>'Hijauan']) }}">Hijauan</a>
					</li>
                    <li class="dropdown-item">
						<a href="{{ route('profil-produk',['id'=>$pengguna->id, 'kategori'=>'Bahan Mentah Pakan']) }}">Bahan Mentah Pakan</a>
					</li>
                    <li class="dropdown-item">
						<a href="{{ route('profil-produk',['id'=>$pengguna->id, 'kategori'=>'Produk Peternak Binaan']) }}">Produk Peternak Binaan</a>
					</li>
				</ul>
				<!-- /DROPDOWN -->
...
<!-- Mirrored from odindesign-themes.com/emerald-dragon/author-profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Mar 2019 18:23:13 GMT -->
</html>
