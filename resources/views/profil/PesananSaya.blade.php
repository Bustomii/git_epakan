			...
			<div class="content right">
				<!-- CART -->
					...
					<nav class="nav nav-pills flex-column flex-sm-row">
						<a class="flex-sm-fill text-sm-center nav-link active" href="{{route('pesanan')}}">Belum Bayar</a>
                ...
                <!-- CART -->
						...
						<div class="p-3">
							...
							<div class="container">
								...
								<a href="{{route('ubahStatusBatal', $data->id_pesanan)}}">
									<button type="button" class="btn btn-success float-right">Batalkan Pesanan</button>
								</a>
								
								<a href="{{route('detail-pesanan', $data->id_pesanan)}}">
