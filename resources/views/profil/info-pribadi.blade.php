		...
		<div class="section">
			...
			<div class="sidebar left">
				...
				<div class="sidebar-item">
					...
					<h4>{{$pengguna->nama}}</h4>
					<!-- open by MIDevoloper -->
				<h>Saldo Rp. <?php if ($total==NULL){echo '0';}else{echo $total;}?></h>
				<form class= p-3 method="POST" action="{{route('cairkan')}}" enctype="multipart/form-data">
				@csrf
				<?php if($total!=NULL) {?>
				@foreach($id_saldo as $x)
					<input type="hidden" id="id_saldo" name="total" value="{{$total}}">
					<input type="hidden" id="id_saldo" name="case" value="1">
					<input type="hidden" id="id_saldo" name="id_saldo[]" value="{{$x->id_saldo}}">
					<input type="hidden" id="id_saldo" name="status[]" value="{{$x->saldo}}">
					@endforeach
						<button type="submit" class="btn btn-success float-right">Cairkan</button>
				<?php }
					else { ?>
					<input type="hidden" id="id_saldo" name="case" value="0">
					<button type="submit" class="btn btn-success float-right" onclick="return confirm('Apakah anda yakin untuk Mencairkan Saldo Anda')">Cairkan</button>
				<?php
					}
				?>
					</form>
                    ...
                    <div class="profile-image">
					 ...
					 <form class="p-3">
						<div class="form-group row">
							...
							<div class="col-sm-10">
							<input type="email" class="form-control" id="inputEmail3" value="{{$pengguna->nama}}" disabled="">
							</div>
						<br/>
						<br/>
							<label for="inputEmail3" class="col-sm-2 col-form-label">Nomor Telpon</label>
							<div class="col-sm-10">
							<input type="email" class="form-control" id="inputEmail3" value="{{$pengguna->no_telp}}" disabled="">
							</div>
						<br/>
						<br/>
                            ...
                            <input type="email" class="form-control" id="inputEmail3" value="{{$pengguna->email}}" disabled="">
							 </div>
                             <br/>
						    <br/>
                            ...
                            <input type="email" class="form-control" id="inputEmail3" value="{{$pengguna->alamat}}" disabled="">
							 </div>
							 <br/>
						    <br/>
							 <label for="inputEmail3" class="col-sm-2 col-form-label">Daerah</label>
							<div class="col-sm-10">

                            <input type="email" class="form-control" id="inputEmail3" value="{{$pengguna->daerah}}" disabled="">
							 </div>
