	...
	<div class="section-wrap">
		<div class="section">
			...
			<div class="center">
				...
				<div class="cart bantuan">
                    <br/>
                <center>
                    <h1 style="color:black">Halo! Apa yang bisa kami bantu?</h1>
                </center>
                <br/>
                <br/>
                <br/>
                <br/>
                <br/>
                <h3>Hubungi Custemer Service Kami</h3>
                <br/>
                <br/>
                <center>
                <h4>CS  : 0812345678</h4></center>
