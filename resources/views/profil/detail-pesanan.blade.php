...
<body>
	...
	<div id="mobile-menu" class="side-menu left closed">
		...
		<ul class="dropdown dark hover-effect interactive">
			...
			<!-- DROPDOWN ITEM -->
			<li class="dropdown-item">
				<a href="{{Route('test13')}}">Cara Beli</a>
			</li>
			<!-- /DROPDOWN ITEM -->
	...
	<div class="section-wrap">
		<div class="section">
			...
			@csrf
				...
				<!-- CART -->
				<div class="cart bayar">
					<!-- CART HEADER -->
					<div class="cart-header">
                        <div class= p-3>
                            <div class="cart-header-product">
								<h4>Kode Transaksi {{$kode}}</h4>
					...
					@foreach($detail as $object)
							<p class="text-header small">Status : {{$object->status}}</p>
                            <hr/>
                            <p >Lakukan Pembayaran ke No. Rekening</p>
                            <h3>BNI Syariah</h3>
							<h3>Kode Bank : 427 </h3>
							<h3>No. Rek : 0814014758</h3>
							<h3>a.n ASTRIA HIJRIANI <H3>
				
								<p >Sebesar  {{$object->total_keuntungan}}</p>
								@endforeach   
								 
							
							
                            <h4>UPLOAD BUKTI PEMBAYARAN</h4>
                                <form action="{{Route('message')}}" enctype="multipart/form-data" method="POST">
								@csrf
                                     <input type="file" name="pembayaran" required> 
									 <input type="hidden" name="id_pesanan" value='{{$kode}}'> 
								</div>			
								<div class="cart-actions">
								<input name="submit" type="submit" class="button mid primary" value="Oke">
					</form>
					<form action="{{Route('batalbayar')}}" enctype="multipart/form-data" method="GET">
						<input name="submit" type="submit" class="button mid primary" value="Batal">
					</div>
				</form>
			</div>
        <br/>
