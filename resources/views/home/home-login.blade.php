...
<body>
	...
	<div id="account-options-menu" class="side-menu right closed">
		...
		<!-- SIDE MENU TITLE -->
		<p class="side-menu-title">Silahkan Masukan Akun Anda</p>
		<!-- /SIDE MENU TITLE -->
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                          <form id="profile-info-form">
                              ...
                              <div class="input-container">
                                  <label for="new_email" class="">Nomor Telepon</label>
                                  <input type="email" id="new_email" name="new_email" placeholder="Masukan Nomor Telpon">
                              </div>
                              <!-- /INPUT CONTAINER -->

                              <!-- INPUT CONTAINER -->
                              <div class="input-container">
                                  <label for="about" class="">hfjahjakshfjk</label>
                                  <input type="text" id="about" name="about" placeholder="Masukan Email">
                              </div>
                      ...
                      <div class="modal-footer">
                          <a href="{{ route('welcome') }}">
                        <button type="button" class="btn btn-success" style="color:#ffffff">Daftar</button>
                    </a>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                              ...
                              <div class="input-container">
                                  <label for="new_email" class="">Username/Email</label>
                                  <input type="email" id="new_email" name="new_email" placeholder="Masukan Username/Email">
                              </div>
                              <!-- /INPUT CONTAINER -->
                              ...
                              <div class="input-container">
                                  <label for="about" class="">Password</label>
                                  <input type="text" id="about" name="about" placeholder="Masukan Password">
                              </div>
                              <!-- /INPUT CONTAINER -->
                      ...
                      <div class="modal-footer">
                          <a href="{{ route('welcome') }}">
                        <button type="button" class="btn btn-success" style="color:#ffffff">Masuk</button>
                        </a>
                      </div>
                    </div>
                  </div>
	...
	<div class="main-menu-wrap">
		<div class="menu-bar">
			...
			<form class="search-form">
				<input type="text" class="rounded" name="search" id="search_products" placeholder="Cari Produk">
		...
		<section class="banner">
			...
			<div class="search-widget">
				<form class="search-widget-form">
					<input type="text" name="category_name" placeholder="Cari Produk">
					<label for="categories" class="select-block">
						<select name="categories" id="categories">
					
							<option value="1">Pakan Sapi</option>
							<option value="2">Pakan Kuda</option>
							<option value="3">Pakan Domba & Kambing</option>
							<option value="4">Pakan Ayam</option>
							<option value="5">Pakan Kerbau</option>
							<option value="6">Supplement</option>
							<option value="7">Hijauan</option>
							<option value="8">Bahan Mentah Pakan</option>
                            <option value="9">Produk Perternak Binaan</option>
						</select>
						<!-- SVG ARROW -->
						<svg class="svg-arrow">
			...
			<div class="product-showcase">
				...
				<div id="pl-1" class="product-list grid column4-wrap owl-carousel">
					...
					<div class="product-item column">
						...
						<div class="product-preview-actions">
							...
							<figure class="product-preview-image">
								<img src="{{ asset('images/items/pakan.jpg') }} " alt="product-image">
							</figure>
							<!-- /PRODUCT PREVIEW IMAGE -->
						...
						<div class="product-info">
							<a href="{{ route('test10') }}">
								<p class="text-header">Pakan Sapi Penggemukan</p>
							</a>
                            <p class="product-description">Lorem ipsum dolor sit urarde...</p>
						
								<p class="category primary">Pakan Sapi</p>
							
							<p class="price"><span>Rp</span>15K/kg</p>
						</div>
						<!-- /PRODUCT INFO -->
						...
						<div class="user-rating">
								...
								<figure class="user-avatar small">
									<img src="{{ asset('images/avatars/avatar_22.jpg') }} " alt="user-avatar">
								</figure>
								<p class="text-header tiny">Raman Farm</p>
					...
					<div class="product-item column">
						...
						<div class="product-info">
							<a href="">
								<p class="text-header">Pakan Kerbau</p>
							</a>
							<p class="product-description">Lorem ipsum dolor sit urarde...</p>
						
								<p class="category primary">Pakan Kerbau</p>
						...
						<div class="user-rating">
								...
								<figure class="user-avatar small">
									<img src="{{ asset('images/avatars/avatar_09.jpg') }} " alt="user-avatar">
								</figure>
					...
					<div class="product-item column">
						...
						<div class="product-info">
							<a href="">
								<p class="text-header">Pakan Domba</p>
							</a>
							<p class="product-description">Lorem ipsum dolor sit urarde...</p>
							
								<p class="category primary">Pakan Domba</p>
						...
						<div class="user-rating">
								...
								<figure class="user-avatar small">
									<img src="{{ asset('images/avatars/avatar_06.jpg') }} " alt="user-avatar">
								</figure>
					...
					<div class="product-item column">
						...
						<div class="product-info">
							<a href="">
								<p class="text-header">Pakan Ayam</p>
							</a>
							<p class="product-description">Lorem ipsum dolor sit urarde...</p>
							
								<p class="category primary">Pakan Ayam</p>
					...
					<div class="product-item column">
						...
						<div class="product-info">
							<a href="">
								<p class="text-header">Pakan Kuda</p>
							</a>
							<p class="product-description">Lorem ipsum dolor sit urarde...</p>
							
								<p class="category primary">Pakan Kuda</p>
					...
					<div class="product-item column">
						...
						<div class="product-info">
							<a href="">
								<p class="text-header">Suplemen</p>
							</a>
							<p class="product-description">Lorem ipsum dolor sit urarde...</p>
							
								<p class="category primary">Suplemen</p>
					...
					<div class="product-item column">
						...
						<div class="product-info">
							<a href="">
								<p class="text-header">Hijauan</p>
							</a>
							<p class="product-description">Lorem ipsum dolor sit urarde...</p>
						
								<p class="category primary">Hijauan</p>
							
							<p class="price"><span>Rp</span>15/kg</p>
						</div>
						<!-- /PRODUCT INFO -->
						<hr class="line-separator">
				...
				<div id="pl-2" class="product-list grid column4-wrap owl-carousel">
					...
					<div class="product-item column">
						...
						<div class="user-rating">
								...
								<figure class="user-avatar small">
									<img src="{{ asset('images/avatars/avatar_04.jpg') }} " alt="user-avatar">
								</figure>
					...
					<div class="product-item column">
						...
						<div class="user-rating">
								...
								<figure class="user-avatar small">
									<img src="{{ asset('images/avatars/avatar_10.jpg') }} " alt="user-avatar">
								</figure>
